...
import com.vigjoaopaulo.api_rest_2021.adapters.ListUserAdapter;
    ...
    public void retornaProduto(){
        ...
        call.enqueue(new Callback<List<Anuncios>>() {
            ...
            public void onResponse(Call<List<Anuncios>> call, Response<List<Anuncios>> response) {
                ...
                listView.setAdapter(new ListUserAdapter(TesteActivity.this, R.layout.painel_controle_activity, anuncios));
            }
